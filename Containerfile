...
RUN grep -q "cpe:/o:centos:centos:10" /etc/os-release && (rm -rf /etc/yum.repos.d/* && curl -o /etc/yum.repos.d/cs.repo "https://gitlab.com/redhat/centos-stream/containers/bootc/-/raw/c10s/cs.repo?ref_type=heads")
