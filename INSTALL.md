...
```bash
skopeo copy docker://ghcr.io/charles19132/calcite:latest oci:container
```
...
%post --erroronfail
bootc switch --mutate-in-place --transport registry ghcr.io/charles19132/calcite:latest
%end
EOF
```
